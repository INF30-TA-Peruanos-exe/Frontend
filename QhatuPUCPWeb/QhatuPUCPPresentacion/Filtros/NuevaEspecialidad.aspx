        ...
        <div class="card-header bg-secondary bg-gradient text-white">
         ...
         <div class="card-body">
             <div class="mb-3">
                 ...
                 <asp:TextBox ID="TxtIdEspecialidad" runat="server" CssClass="form-control bg-white text-black border-secondary" ReadOnly="true" placeholder="(Se genera automáticamente)"></asp:TextBox>
             </div>
                 <!-- Nombre Facultad -->
            <div class="mb-3">
