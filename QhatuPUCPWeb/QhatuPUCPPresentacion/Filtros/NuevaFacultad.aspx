<%@ Page Title="Nueva Facultad" Language="C#" MasterPageFile="~/MainLayoutMasterAdmin.Master" AutoEventWireup="true" CodeBehind="NuevaFacultad.aspx.cs" Inherits="QhatuPUCPPresentacion.Filtros.NuevaFacultad" %>
        ...
        <div class="card bg-white text-dark shadow-lg border-light">
            <div class="card-header bg-secondary bg-gradient text-white">
                <h3 class="fw-bold mb-0">
                    ...
                    <asp:Label ID="LblTitulo" runat="server" Text="Nueva Facultad"></asp:Label>
                </h3>
            </div>  
            ...
            <div class="card-body">
                <!-- Id Facultad -->
                <div class="mb-3">
                    <label for="TxtIdFacultad" class="form-label">ID de Facultad</label>
                    <asp:TextBox ID="TxtIdFacultad" runat="server" CssClass="form-control bg-white text-black border-secondary" ReadOnly="true" placeholder="(Se genera automáticamente)"></asp:TextBox>
                </div>
